...
import { PdfCode } from "../../constants/PdfCode";
...
const Box = () => {
  ...
  const printToFile = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Make shure You have Internet Connection or contact @+91 7550343987"
      );
    }
  };
      ...
      <ScrollView>
        ...
        <View style={styles.InputContainer}>
          ...
          <View style={styles.PickerContainer}>
            ...
            >
              <Picker.Item label="InternShip Fees" value="InternShip Fees" />
              <Picker.Item label="Course Fees" value="Course Fees" />
            </Picker>
          </View>
        </View>
        <View style={styles.InputContainer}>
